...
def coords(screen, cam):
    ...
    text_render(screen, "vx = " + str(cam.vx), 50, 150)
    text_render(screen, "vy = " + str(cam.vy), 50, 200)
    text_render(screen, "an_xy = " + str(cam.an_xy), 50, 250)
    text_render(screen, "an_xz = " + str(cam.an_xz), 50, 300)
